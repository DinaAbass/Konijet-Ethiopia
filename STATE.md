...
- Added the Google AdSense script tag loader directly inside `src/app/blog/page.tsx`, `src/app/blog/[slug]/page.tsx`, and `src/app/[...slug]/page.tsx` to ensure crawler verification detects it on all blog subroutes.
